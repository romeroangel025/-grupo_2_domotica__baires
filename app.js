...
app.get("/CarritoDeCompras",(req,res)=>res.sendFile(path.join(__dirname,"views","productCart.html")))
app.get("/Registro",(req,res)=>res.sendFile(path.join(__dirname,"views","register.html")))
app.get("/InicioDeSesion",(req,res)=>res.sendFile(path.join(__dirname,"views","login.html")))
